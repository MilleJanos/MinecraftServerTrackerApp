...
//    private Debug debug;
    ...
    public boolean isIpFound() {
        return ipFound;
    }

    public void setIpFound(boolean ipFound) {
        this.ipFound = ipFound;
    }

    @SerializedName("motd")
    @Expose
    private mj.minecraft.servertracker.model.Motd motd;

    @SerializedName("players")
    @Expose
    private mj.minecraft.servertracker.model.Players players;
...
//    private Info info;
    ...
    public mj.minecraft.servertracker.model.Motd getMotd() {
        return motd;
    }

    public void setMotd(mj.minecraft.servertracker.model.Motd motd) {
        this.motd = motd;
    }

    public mj.minecraft.servertracker.model.Players getPlayers() {
        return players;
    }

    public void setPlayers(mj.minecraft.servertracker.model.Players players) {
